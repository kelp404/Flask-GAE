...
'" class="error_msg help-inline">'+$(this).attr("msg")+"</label>"));return b=!1}});return b},loading_on:function(){return $("body, a, .table-pointer tbody tr").css({cursor:"wait"})},loading_off:function(){$("body").css({cursor:"default"});return $("a, .table-pointer tbody tr").css({cursor:"pointer"})},nav_select:function(a){if(0<=a&&!$($("#js_navigation li")[a]).hasClass("active"))return $("#js_navigation li").removeClass("active"),$($("#js_navigation li")[a]).addClass("active")},setup_nav:function(){var a;
if(a=location.href.match(/\w(\/\w*)/))return a="/"===a[1]?0:$('#js_navigation li a[href*="'+a[1]+'"]').parent().index(),$("#js_navigation li").removeClass("active"),$($("#js_navigation li")[a]).addClass("active")},setup_link:function(){if(!this.is_ie)return $(document).on("click",'a:not([href*="#"])',function(a){if(!a.metaKey){if(0<$(this).closest(".active").length&&0<$(this).closest(".menu").length)return!1;if((a=$(this).attr("href"))&&!$(this).attr("target"))return b.ajax({href:a},!0),!1}}),$(document).on("submit",
'form[method=get]:not([action*="#"])',function(){var a;a=$(this).attr("action")+"?"+$(this).serialize();b.ajax({href:a},!0);return!1}),$(document).on("submit",'form[method=post]:not([action*="#"])',function(){var a;b.validation($(this))&&(a=$(this).attr("action"),b.ajax({href:a,data:$(this).serialize(),method:"post"}),$(".modal.in").modal("hide"));return!1})},setup_enter_submit:function(){return $(document).on("keypress",".enter-submit",function(a){if(13===a.keyCode&&a.ctrlKey)return $(this).closest("form").submit(),
!1})},after_page_loaded:function(){b.setup_datetime();b.setup_focus();b.setup_tooltip();return b.setup_chat()},setup_datetime:function(){return $(".datetime").each(function(){var a;try{return a=new Date($(this).attr("datetime")),$(this).html(a.toFormat($(this).attr("format")))}catch(b){}})},setup_focus:function(){return $(".focus").select()},setup_tooltip:function(){return $('[rel="tooltip"]').tooltip()},setup_chat:function(){var a;if(0<$("#chat").length)return a=window.sessionStorage.chat_token,
$.ajax({type:"post",url:"/chat/setup",dataType:"json",cache:!1,data:{chat_token:a},success:function(a){window.sessionStorage.chat_token=a.chat_token;$("#chat_name").val(a.name);a=new goog.appengine.Channel(a.channel_token);b.socket=a.open();b.socket.onmessage=b.chat_on_message;return b.socket.onerror=b.chat_on_error}});if(b.socket)return b.socket.close()},chat_on_message:function(a){a=JSON.parse(a.data);a.rename&&($("#chat_board").append(a.rename.old_name+" rename to "+a.rename.new_name+"\n"),$("#chat_name").val(a.rename.new_name));
a.message&&$("#chat_board").append(a.name+": "+a.message+"\n");return $("#chat_board").animate({scrollTop:$("#chat_board").prop("scrollHeight")},500,"easeOutExpo")},chat_on_error:function(){window.sessionStorage.removeItem("chat_token");return this.setup_chat()}};window.core=b;d=navigator.userAgent.toLowerCase();b.is_safari=-1!==d.indexOf("safari")&&-1===d.indexOf("chrome");b.is_ie=-1!==d.indexOf("msie")}).call(this);
